    ...
    <div class="logo">
      ...
      <img src="img/logo.png">
        ...
        <h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--------------------------Feedback--------------------------</h1>
            ...
            {
                echo '<tr class="tr">';
                echo '<td class="td1">'.$res['Sr_No'].'</td>';
                echo '<td class="td2">'.$res['Name'].'</td>';
               echo '<td class="td3">'.$res['Enrollment_No'].'</td>';
               echo '<td class="td4">'.$res['Mobile_No'].'</td>';
                echo '<td class="td5">'.$res['Comment'].'</td>';
