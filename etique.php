...
$query="select * from exam_detail where Subject='DBMS'";
...
$result=mysqli_query($conn,"SELECT * FROM `etique` ORDER BY RAND () LIMIT $noque  ");
include("front1.php");
$user=$_SESSION['un'];
