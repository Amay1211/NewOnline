...
.td8
{
    ...
    <div class="logo">
      ...
      <img src="img/logo.png">
        ...
        <div class="btn3">
             <input type="button" value="Back" onclick="window.location='change-question-subopt.php'">
        ...
        <h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;------------------CN Questions------------------</h1>
            ...
            while($res=mysqli_fetch_array($result))
            {
               ...
               echo '<td class="td8"><a href="change-management-question.php?Question_ID='.$res['Question_ID'].'">Edit</td>';
                echo '</tr>';
            }
            ?>
