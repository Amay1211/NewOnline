...
$result=mysqli_query($conn,"select * from estque where Question_ID='$questionid'");

$res=mysqli_fetch_array($result);
?>
<html>
<head>
    <title>change-est-question</title>
    <style>
    .img{
    ...
    <body>
     ...
     <div class="logo">
      ...
      <img src="img/logo.png">
        ...
        <div class="btn3">
             <input type="button" value="Back" onclick="window.location='change-question-est.php'">
         <input type="button" value="Logout" onclick="window.location='adminlogin.html'">
            
        </div>
        <form action="change-est1-question.php" method="post">
        <div class="question">
        <div class="que">
        ...
        <div class="opt">
           ...
           <textarea id="txt8" value="1" disabled='disabled'>2</textarea><textarea id="txt2" required name="txt3"><?php echo $res['OptionB']?></textarea><br>
            ...
            <input type="text" id="txt8" value="Ans" disabled='disabled'><input type="text" id="txt2" required name="txt6" value="<?php echo $res['Answer']?>">
