...
$result=mysqli_query($conn,"select * from etique where Question_ID='$questionid'");

$res=mysqli_fetch_array($result);
?>
<html>
<head>
    <title>change-adv-question</title>
    <style>
    .img{
    ...
    <body>
     ...
     <div class="logo">
      ...
      <img src="img/logo.png">
        ...
        <div class="btn3">
             <input type="button" value="Back" onclick="window.location='change-question-eti.php'">
         <input type="button" value="Logout" onclick="window.location='adminlogin.html'">
            
        </div>
        <form action="change-eti1-question.php" method="post">
        <div class="question">
        <div class="que">
