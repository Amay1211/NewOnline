...
$query="select * from exam_detail where Subject='SPOS'";
...
$result=mysqli_query($conn,"SELECT * FROM `estque` ORDER BY RAND () LIMIT $noque ");
include("front1.php");
$user=$_SESSION['un'];
	...
	<body onload="ctimer()">
     ...
     <div class="logo">
      ...
      <img src="img/logo.png">
        ...
        <div class="date">
         <span id="clock" style="color: white; font-size: 47px;margin-left: 68px;">
             <?php echo $hours.":".$min.":00" ?></span>
